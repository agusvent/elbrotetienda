...
$route['api/extras/delete'] = 'Api/extraDelete';
...
$route['api/orders/pedidosPendientes'] = 'Api/pedidosPendientes';
$route['api/orders/pedidosPendientesSinVer'] = 'Api/pedidosPendientesSinVer';
$route['api/orders/turnOffAlarmaPendiente'] = 'Api/turnOffAlarmaPendiente';
$route['api/orders/editarPedido'] = 'Api/editarPedido';
$route['api/orders/getPedidoById'] = 'Api/getPedidoById';
$route['api/orders/despacharPedido'] = 'Api/despacharPedido';
$route['api/orders/entregarPedido'] = 'Api/entregarPedido';
$route['api/orders/procesarPedidosFijos'] = 'Api/procesarPedidosFijos';
...
$route['ordenes/listadoPedidosPendientes'] = 'Dashboard/listadoPedidosPendientes';
...
$route['api/configuradorPedidos/editLimiteValorFormasPago'] = 'Api/editLimiteValorFormasPago';
