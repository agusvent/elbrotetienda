...
class DiasEntregaBarrios extends CI_Model
{
    ...
    {
        $this->db->select('id, id_dia_entrega, id_barrio');
        $this->db->from('dias_entrega_pedidos');

        return $this->db->get()->result();
    }

    public function getByDiaEntrega($id_dia_entrega)
    {
        $this->db->select('id, id_dia_entrega, id_barrio');
        $this->db->from('dias_entrega_pedidos');
        $this->db->where('id_dia_entrega', $id_dia_entrega);
        return $this->db->get()->result();
    }

    public function add($id_dia_entrega, $id_barrio)
    {
        $this->db->set('id_dia_entrega', $id_dia_entrega);
        $this->db->set('id_barrio', $id_barrio);
        $this->db->insert('dias_entrega_barrios');
    ...
    {
        $this->db->where('id', $id);
        $this->db->delete('dias_entrega_barrios');

        return true;
    }

    public function deleteAllBarrios($idDiaEntrega){
