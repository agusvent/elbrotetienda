...
<table align="center" width="650" style="border: 1px solid #000000;padding: 0;">
    ...
    <tr style="padding: 0;"><td style="padding:20px;">
            ...
            <p>Tu pedido ya está confirmado y te va a estar esperando en el Punto de Retiro el día de entrega, que se indica a continuación.
            </p>
            ...
            <?php endif; ?>
            <p>Te recordamos la dirección y el horario de entrega:</p>
            <p>
                <strong>Día de retiro: <?=$retiro;?><br /></strong>
