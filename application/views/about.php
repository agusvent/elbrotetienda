...
<head>
    ...
    <!-- Main Style CSS -->
    <link rel="stylesheet" href="assets/new_design/assets/css/style.css?v=85746534">
    <link rel="stylesheet" href="assets/new_design/assets/css/ebo.css?v=47634535">
</head>
...
<!-- 
    All JS is here
============================================ -->
<script type="text/javascript">let waypointAboutCounter = 0;</script>
...
<script src="assets/new_design/assets/js/plugins.js?v=828734iu"></script>
<!-- Main JS -->
<script src="assets/new_design/assets/js/main.js?v=1231234"></script>
